...
const [waypointCount, setWaypointCount] = useState(0);
  ...
  <div className="border-t border-zinc-800 my-4"></div>
      ...
      <div>
        ...
        style={{color:"#D2E1F0"}}>Waypoint {waypointCount}</p>
        {/* Starting Point */}
...
//     if (waypoints.startingPoint && waypoints.endingPoint) {
//       setErrorPopup(false); // Hide error popup when both waypoints are filled
//       setPopupVisible(true); // Show preview popup
//     }
//   }, [waypoints]);

//   return (
//     <aside
//       className="w-1/4 h-5/6 ml-3 p-3 pr-5 rounded-3xl flex flex-col relative"
//       style={{ backgroundColor: "#121216" }}
//     >
//       {/* Toggle Buttons */}
//       <ToggleButtons
